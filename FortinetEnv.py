...
PATH_POL_DUMP="/home/x112097/yaml/fortinet/pol"
PATH_RESULT_DUMP="/home/x112097/yaml/fortinet/result"
	...
	def __init__(self,FileConfig="",dump="",caching=False,path=PATH_POL_DUMP,dataDict={}):
		...
		if FileConfig:
			...
			if not caching:
				...
				cachePolFw.save({'address': self.address, 'groups': self.grpAddr, 'rules': self.rules,'static_routes':self.staticRoutes})
			else:
				if cachePolFw.isOK():
