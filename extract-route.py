...
if __name__ == '__main__':
	...
	parser.add_argument("--list-all-nexhop",action="store_true",dest='list_all_nexthop',help=u'get all nexthop',required=False)
	...
	if args.Print:
		if args.nexthop or args.protocol or args.vrf or args.prefix_filter or args.liste_nexthop:
			if args.format:
